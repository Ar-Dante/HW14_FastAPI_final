...
class Auth:
    ...
    def get_password_hash(self, password: str):
        ...
        :param password: str: Define the password that will be hashed
    ...
    async def create_access_token(self, data: dict, expires_delta: Optional[float] = None):
        ...
        :return: A token that is encoded with the data provided
        """
        to_encode = data.copy()
        if expires_delta:
    ...
    async def create_refresh_token(self, data: dict, expires_delta: Optional[float] = None):
        ...
        :param self: Represent the instance of the class
        :param data: dict: Pass in the user's data, which is used to create a refresh token
    ...
    async def get_current_user(self, token: str = Depends(oauth2_scheme), db: Session = Depends(get_db)):
        ...
        :return: The user object, which is a dictionary
        """
